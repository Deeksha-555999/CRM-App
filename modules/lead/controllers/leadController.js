...
class LeadController {
  static createLead = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, "Create lead request", {
      name: req.body.name,
      email: req.body.email,
      apiId: req.apiId,
    });

    const { name, email, phone, company, source, status, notes, assigned_to } =
      req.body;
    ...
    logger.log(apiReference, "Lead created successfully", {
      leadId: result.id,
    });
  ...
  static getAllLeads = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, "Get all leads request", {
      page: req.query.page,
    ...
    logger.log(apiReference, "Leads retrieved successfully", {
