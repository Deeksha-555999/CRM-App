...
class AdminController {
  ...
  static getAllUsers = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, "Get all users request", {
      page,
      limit,
      search,
      status,
    ...
    logger.log(apiReference, "Users fetched successfully", {
  ...
  static getUnverifiedUsers = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, "Unverified users fetched successfully", {
      count: users.length,
    });
  ...
  static verifyUser = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, `User ${action}d successfully`, {
      userId: id,
      action,
    });
  ...
  static updateUserRole = asyncHandler(async (req, res) => {
    ...
    logger.log(apiReference, "Update user role request", {
      userId: id,
      newRole: role,
    });
    ...
    logger.log(apiReference, "User role updated successfully", {
      userId: id,
      newRole: role,
    });
